                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-8">
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <p className="text-slate-400 mb-4">
                            The next generation of decentralized blockchain infrastructure for AI
                            and gaming.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li className="flex items-start">
                                <svg
                                    className="h-5 w-5 text-slate-400 mr-2 mt-0.5"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                >
                                ...
                                <span className="text-slate-400">support@solana-chain.network</span>
                            </li>
                            <li className="flex items-start">
                                <svg
                                    className="h-5 w-5 text-slate-400 mr-2 mt-0.5"
                ...
                <div className="border-t border-slate-800 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-slate-400 text-sm">
                            © 2025 Solana Chain Network. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
